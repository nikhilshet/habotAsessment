  ...
  return (
    <>
        <section className='w-full bg-[#E8FBFF] mb-24 py-24 flex flex-col justify-between items-center xl:flex-row xl:px-32 '>
            ...
            <button className='bg-[#EB7150] text-white text-lg rounded-lg px-3 py-2 xl:px-6 xl:py-4 transition-all duration-200 hover:bg-white hover:text-[#E7760D] hover:border-1 hover:border-[#E7760D] '>Get Verified</button>
        </section>
    </>
  )
}
